    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-blue-600">Axis Finance App</span>
        </div>
        <nav className="hidden md:flex items-center gap-8">
          <a href="#recursos" className="text-gray-700 hover:text-gray-900">Recursos</a>
          <a href="#precos" className="text-gray-700 hover:text-gray-900">Preços</a>
          <a href="#depoimentos" className="text-gray-700 hover:text-gray-900">Depoimentos</a>
      ...
      {/* Hero Section - Clone Exato da Imagem */}
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Título Principal com palavras destacadas */}
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Controle suas finanças de forma{' '}
            <span className="text-green-500">simples</span> e{' '}
            <span className="text-blue-500">rápida</span> pelo{' '}
          ...
          <Button 
            size="lg" 
            className="bg-green-500 hover:bg-green-600 text-white px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-xl transition-all"
          >
            Adquirir Agora
      ...
      {/* Segunda Seção - Mockup Responsivo com Imagem dos Celulares */}
      <section className="container mx-auto px-4 py-12 md:py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            {/* Badge Verde */}
            <div className="inline-flex items-center gap-2 bg-green-500 text-white rounded-full px-4 py-2 mb-6">
          ...
          {/* Mockup com Efeitos Visuais */}
          <div className="relative w-full">
            {/* Efeito de Glow/Brilho de Fundo */}
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 via-green-400/20 to-blue-400/20 blur-3xl -z-10"></div>
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-[1.02]">
              {/* Mobile: altura otimizada para nitidez */}
              ...
              {/* Desktop: altura grande para máxima nitidez */}
            ...
            <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 w-3/4 h-20 bg-gradient-to-b from-blue-500/10 to-transparent blur-2xl"></div>
          </div>

          {/* Badge abaixo da mockup */}
          <div className="text-center mt-12">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-full px-6 py-3 shadow-lg">
          ...
          <div className="max-w-4xl mx-auto mt-16 px-4 text-left">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              ...
              <p>
                Foi por isso que criamos o <span className="font-bold text-green-500">Axis Finance App</span>, uma ferramenta inteligente que combina o melhor da organização financeira com a gestão de compromissos, tudo de forma simples e direta pelo WhatsApp.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Terceira Seção - Mockup com Vídeo e Texto */}
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-2 md:order-1 space-y-6">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Tudo na{' '}
                <span className="text-orange-500">palma da sua mão</span>
              </h2>
            ...
            <div className="order-1 md:order-2 relative">
              {/* Efeito de Glow */}
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 via-pink-400/20 to-orange-400/20 blur-3xl -z-10"></div>
              ...
              {/* Efeito de Reflexo */}
              <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-3/4 h-16 bg-gradient-to-b from-orange-500/10 to-transparent blur-2xl"></div>
            </div>
          </div>
        </div>
      </section>

      {/* Nova Seção - Como Funciona o Organizy */}
      <section className="container mx-auto px-4 py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Grid de Passos e Funcionalidades */}
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 mb-12 shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <Card className="border-2 border-blue-200 bg-blue-50 shadow-lg hover:shadow-xl transition-all">
              <CardHeader>
            ...
            <Card className="border-2 border-green-200 bg-green-50 shadow-lg hover:shadow-xl transition-all">
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
          ...
          <div className="text-center">
            ...
            <Button 
              size="lg" 
              className="bg-orange-500 hover:bg-orange-600 text-white px-10 py-6 text-lg rounded-full shadow-lg hover:shadow-xl transition-all"
            >
              Começar Agora Mesmo
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
      ...
      <section className="container mx-auto px-4 py-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Coluna Esquerda - Mockup Laranja do Vídeo */}
            <div className="order-2 md:order-1">
              <div className="relative bg-gradient-to-br from-orange-400 to-orange-600 rounded-3xl p-8 shadow-2xl">
                ...
                {/* Efeito de Brilho */}
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-pink-500 rounded-3xl blur-xl opacity-30 -z-10"></div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Com o seu <strong className="text-orange-500">Organizy</strong>, você gerencia suas finanças direto pelo WhatsApp de forma simples e intuitiva. Sem complicações, sem aplicativos extras.
              </p>
      ...
      <section className="container mx-auto px-4 py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          {/* Badge e Título */}
          <div className="text-center mb-12">
            <div className="inline-block bg-orange-500 text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
              FUNCIONALIDADES
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 - Visualize Seu Futuro Financeiro */}
            ...
            {/* Card 2 - Categorização Automática */}
            <Card className="border-none shadow-lg hover:shadow-xl transition-all bg-white">
              <CardHeader>
            ...
            {/* Card 3 - Controle Total do Orçamento */}
            <Card className="border-none shadow-lg hover:shadow-xl transition-all bg-white">
              <CardHeader>
            ...
            {/* Card 4 - Metas Financeiras Inteligentes */}
            <Card className="border-none shadow-lg hover:shadow-xl transition-all bg-white">
              <CardHeader>
            ...
            {/* Card 6 - Planejamento de Longo Prazo */}
            <Card className="border-none shadow-lg hover:shadow-xl transition-all bg-white">
              <CardHeader>
      ...
      <section className="container mx-auto px-4 py-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              O Organizy é para{' '}
              <span className="text-orange-500">qualquer pessoa</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          {/* Grid de Cards - Vida Pessoal e Empresarial */}
          ...
          {/* Seção Destacada Final com Estrela */}
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 md:p-12 shadow-2xl">
      ...
      {/* Depoimentos com Fotos de Perfil e Screenshots */}
      <section id="depoimentos" className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {/* Depoimento 3 - Ricardo Mendes (outro feedback) */}
            <Card className="border-none shadow-lg overflow-hidden">
              <CardContent className="p-0">
                {/* Screenshot do WhatsApp */}
                <div className="relative w-full h-[300px] bg-gray-100">
      ...
      {/* NOVA SEÇÃO DE ASSINATURA - Pronto para transformar suas finanças? */}
      <section id="precos" className="container mx-auto px-4 py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="border-2 border-green-500 shadow-2xl overflow-hidden mb-12">
            <CardContent className="p-8 md:p-12">
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center gap-2">
                  ...
                  <span className="text-5xl md:text-7xl font-bold text-green-600">R$ 29,90</span>
                </div>
              ...
              <Button 
                size="lg" 
                className="w-full bg-green-600 hover:bg-green-700 text-white text-xl py-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
              >
          ...
          {/* Seção de Garantia */}
          <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-3xl p-8 md:p-12 border-2 border-blue-200 shadow-xl">
        ...
        <div className="container mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="max-w-2xl mx-auto">
            <AccordionItem value="item-1">
              <AccordionTrigger>Por que não usar planilhas do Excel ou Google Sheets?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>Funciona no celular? E se eu quiser usar no computador?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger>É difícil de usar? Preciso entender de finanças?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger>Como funciona o assistente WhatsApp?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-6">
              <AccordionTrigger>Vale a pena o investimento? Vou economizar dinheiro?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-7">
              <AccordionTrigger>Vocês oferecem suporte? E se eu tiver dúvidas?</AccordionTrigger>
              <AccordionContent>
